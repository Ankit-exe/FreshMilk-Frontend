...
export const HomePage = () => {
  ...
  return (
      ...
      <div className=" absolute w-full grid grid-cols-1 md:grid-cols-2 container lg:px-[50px] mt-9 ">
        <div className="grid content-center lg:mt-[-200px]  md:mt-9  space-y-[-10px]">
          ...
          <p className="font-medium text-white text-wrap ">
            ...
            your doorstep, savor the rich taste and quality of our farm-fresh{" "}
            
            milk. Experience freshness like never before!"
    ...
    <section className='flex flex-col gap-12 z-10 row-span-2 container mt-40 md:-mt-20 '>
        <div className='bg-white border-2 border-slate-200 bg-opacity-10 rounded-lg shadow-md py-8 flex flex-col gap-5 text-center'>
        ...
        <div className="grid md:grid-cols-2 gap-5 p-5">
          ...
          <div className="flex flex-col items-center justify-center gap-4 text-center">
            ...
            <span>
              Download the FreshMilk App for faster ordering and personalised recommendations.
            </span>
